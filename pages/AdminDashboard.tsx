      ...
      {activeTab === 'inventory' && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
                {tractors.map(t => (
                    <div key={t.id} className="bg-white p-4 rounded-xl shadow-sm border border-gray-200 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <img src={t.image} alt={t.model} className="w-16 h-16 rounded object-cover bg-gray-100" />
                            <div>
                                <h4 className="font-bold text-gray-900">{t.brand} {t.model}</h4>
                                <p className="text-sm text-gray-600">{t.variant} • {t.hp} HP</p>
                            </div>
                        </div>
                        <button 
